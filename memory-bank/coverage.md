...
| `Convert/RGB` | Packed BGR to planar RGB/RGBA | RGB24/RGB48 and RGB32/RGB64 source templates for SSE2, SSSE3, and AVX2, with and without target alpha | Fixed channel-anchor inputs stored in packed bottom-up order; independent component-layout reference; alpha insertion, dropping, and preservation; overlapping 3-component SIMD tails; aligned component-source rows; active-plane hashes, source immutability, unused-alpha preservation, padding, and guard checks. Public scalar counterparts are unavailable. |
