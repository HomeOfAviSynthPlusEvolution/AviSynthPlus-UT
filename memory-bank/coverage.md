...
| `Focus` | Planar horizontal and vertical three-tap blur/sharpen for 8- and 16-bit samples | Horizontal 8-bit SSE2 and AVX2; horizontal 16-bit SSE2, SSE4.1, and AVX2; vertical 8-bit SSE2 and AVX2; vertical 16-bit SSE2, SSE4.1, and AVX2 | Fixed boundary/ramp input with blur and sharpen weights; independent edge-replicating fixed-point reference; vector-tail coverage; active-output hashes, row padding, guards, and line-buffer checks |
